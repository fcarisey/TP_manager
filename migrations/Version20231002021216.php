...
final class Version20231002021216 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tache (id INT AUTO_INCREMENT NOT NULL, tp_id_id INT DEFAULT NULL, ordre INT NOT NULL, point INT NOT NULL, description LONGTEXT NOT NULL, INDEX IDX_93872075E5EE4340 (tp_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tp (id INT AUTO_INCREMENT NOT NULL, classe_id_id INT DEFAULT NULL, titre VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, fichier VARCHAR(255) DEFAULT NULL, date_debut DATETIME DEFAULT NULL, date_fin DATETIME DEFAULT NULL, INDEX IDX_5A8FDF313633CA6F (classe_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
