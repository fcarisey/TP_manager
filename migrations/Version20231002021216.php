 ...
 */
final class Version20231002021216 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tache (id INT AUTO_INCREMENT NOT NULL, tp_id INT DEFAULT NULL, ordre INT NOT NULL, point INT NOT NULL, description LONGTEXT NOT NULL, INDEX IDX_93872075E5EE4340 (tp_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tp (id INT AUTO_INCREMENT NOT NULL, classe_id INT DEFAULT NULL, titre VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, fichier VARCHAR(255) DEFAULT NULL, date_debut DATETIME DEFAULT NULL, date_fin DATETIME DEFAULT NULL, INDEX IDX_5A8FDF313633CA6F (classe_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, classe_id INT DEFAULT NULL, nom VARCHAR(50) NOT NULL, prenom VARCHAR(50) NOT NULL, mot_de_passe VARCHAR(255) NOT NULL, courriel VARCHAR(255) NOT NULL, role VARCHAR(50) NOT NULL, INDEX IDX_1D1C63B33633CA6F (classe_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE tache ADD CONSTRAINT FK_93872075E5EE4340 FOREIGN KEY (tp_id) REFERENCES tp (id)');
        ...
        $this->addSql('ALTER TABLE tp ADD CONSTRAINT FK_5A8FDF313633CA6F FOREIGN KEY (classe_id) REFERENCES classe (id)');
        $this->addSql('ALTER TABLE utilisateur ADD CONSTRAINT FK_1D1C63B33633CA6F FOREIGN KEY (classe_id) REFERENCES classe (id)');
    }
